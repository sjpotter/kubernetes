		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Properties: map[string]spec.Schema{
					...
					"ExperimentalOverrideLimits": {
						SchemaProps: spec.SchemaProps{
							Description: "FIXME: add comment from types.go Thise flag, if set, enables kubelet to override the detected cpu and memory limits",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"CPULimit": {
						SchemaProps: spec.SchemaProps{
							Description: "These flags, if set, work with the above Override flag to restrict the limits, otherwise they are unrestricted",
							Type:        []string{"integer"},
							Format:      "int64",
						},
					},
